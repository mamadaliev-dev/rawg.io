package uz.mamadalievdev.rawg.data.service
...
class DownloadService : IntentService("DownloadService") {
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        try {
            ...
            val directory =
                File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).absolutePath + "/rawg")
            if (!directory.exists()) {
                directory.mkdir()
            }
    ...
    companion object {
        ...
        const val NOTIFICATION = "uz.mamadalievdev.rawg"
